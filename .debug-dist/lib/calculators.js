...
exports.calculators = [
    {
        ...
        description: 'Dimensiona e verifica travi in cemento armato secondo NTC 2018 ed Eurocodici, con controllo di presso-tenso flessione e taglio.',
        metaDescription: 'Calcolatore professionale per il dimensionamento delle travi in cemento armato. Verifiche secondo NTC 2018, combinazioni SLU/SLE e output pronti per la relazione strutturale.',
        ...
        author: config_1.defaultAuthors.engineer,
    ...
    },
    {
        ...
        description: 'Genera la matrice di rischio cantieri con individuazione pericoli, misure preventive, livello di esposizione e priorità di intervento.',
        metaDescription: 'Strumento per la valutazione dei rischi nei cantieri temporanei o mobili. Include pericoli standard, DPI consigliati, piani di monitoraggio e output per PSC/POS.',
        ...
        author: config_1.defaultAuthors.safetyCoordinator,
    ...
    },
    {
        ...
        description: 'Calcola la trasmittanza termica U di pareti opache stratificate con verifica requisiti minimi e confronto con limiti legislativi.',
        metaDescription: 'Calcolatore termotecnico per il calcolo della trasmittanza delle pareti. Inserisci gli strati e ottieni U, massa superficiale e verifiche DM 26/06/2015.',
        ...
        author: config_1.defaultAuthors.acousticsEngineer,
    ...
    },
    {
        ...
        description: 'Dimensiona cavi elettrici in bassa tensione con verifica portata, caduta di tensione, protezioni magnetotermiche e coordinamento.',
        metaDescription: 'Calcolatore per il dimensionamento dei cavi elettrici BT secondo CEI 64-8. Valuta sezione, caduta V, corrente ammissibile e protezioni automatiche.',
        ...
        author: config_1.defaultAuthors.electricalEngineer,
    ...
    },
    {
        ...
        description: 'Esegue il dimensionamento di reti fognarie pluviali e miste con metodo razionale, verifica velocità e pendenze minime.',
        metaDescription: 'Strumento per progettare condotte fognarie: calcola portate di progetto, diametri commerciali, velocità e riporta report sintetico per memoria tecnica.',
        ...
        author: config_1.defaultAuthors.hydraulicEngineer,
    ...
    },
    {
        ...
        description: 'Calcola la portanza di pali trivellati e battuti con contributo laterale, punta e fattori di sicurezza secondo NTC 2018.',
        metaDescription: 'Calcolatore geotecnico per la verifica della capacità portante dei pali di fondazione. Include stratigrafie, prove penetrometriche e calcolo cedimenti.',
        ...
        author: config_1.defaultAuthors.geotechnicalEngineer,
    ...
    },
    {
        ...
        description: 'Calcola il punto di pareggio aziendale con identificazione dei costi fissi/variabili, margine di contribuzione e grafico BEP.',
        metaDescription: 'Tool per la determinazione del break even point. Inserisci costi e ricavi unitari per valutare margine di sicurezza e volumi di pareggio.',
        category: 'finanza-business',
        keywords: [
            'break even point',
            'punto di pareggio',
    ...
    },
    {
        ...
        description: 'Esegue la trasformazione di coordinate tra sistemi Gauss-Boaga, UTM e WGS84 con compensazione e verifica scarti.',
        metaDescription: 'Calcolatore topografico per convertire coordinate Gauss-Boaga in UTM/WGS84. Include rototraslazioni 7 parametri e report degli errori.',
        ...
        author: config_1.defaultAuthors.surveySpecialist,
    ...
    },
    {
        ...
        description: 'Converte in tempo reale le principali unità di pressione (Pa, bar, psi, atm, mmHg) con precisione industriale.',
        metaDescription: 'Convertitore tecnico di pressione con fattori aggiornati. Supporta Pascal, bar, psi, atmosfera tecnica, mmHg e kPa con cronologia conversioni.',
        ...
        author: config_1.defaultAuthors.conversionSpecialist,
    ...
    },
    {
        ...
        description: 'Organizza scadenze, permessi, verifiche periodiche e documenti di un cantiere con timeline e notifiche automatiche.',
        metaDescription: 'Planner digitale per monitorare scadenze di cantieri e studi tecnici: permessi, collaudi, verifiche DPI e aggiornamenti documentali.',
        ...
        author: config_1.defaultAuthors.operationsManager,
