...
export const calculators: Calculator[] = [
  ...
  },
  {
    ...
    title: 'Calcolo Percentuale Rapido',
    description:
      'Calcola percentuali, variazioni percentuali e incrementi/decrementi tra due valori in pochi passaggi.',
    metaDescription:
      'Calcolatore percentuale rapido: ottieni valori percentuali, variazioni e incrementi tra due numeri.',
  ...
  {
    slug: 'calcolo-proporzioni-regola-del-tre',
    title: 'Calcolo Proporzioni (Regola del Tre)',
    description:
      'Risolve proporzioni dirette o inverse per trovare il valore incognito X con la regola del tre semplice.',
    metaDescription:
      'Calcolatore proporzioni con regola del tre per dosaggi, scale di disegno e rapporti diretti o inversi.',
    category: 'strumenti-quotidiani',
    keywords: [
      'regola del tre',
      'proporzioni',
  ...
  },
  {
    ...
    description:
      'Calcola il numero di giorni totali, mesi e anni tra due date specifiche con considerazione degli anni bisestili.',
    metaDescription:
      'Calcolatore giorni tra date: ottieni differenza in giorni, mesi e anni tra due date con supporto ai bisestili.',
    category: 'strumenti-quotidiani',
    keywords: [
      'giorni tra date',
      'differenza date',
  ...
  {
    slug: 'calcolo-giorni-lavorativi',
    title: 'Calcolo Giorni Lavorativi',
    description:
      'Calcola il numero di giorni lavorativi tra due date escludendo weekend e festività italiane configurabili.',
    metaDescription:
      'Calcolatore giorni lavorativi: escludi sabati, domeniche e festività per determinare scadenze e tempi di progetto.',
    category: 'strumenti-quotidiani',
    keywords: [
      'giorni lavorativi',
      'scadenze',
  ...
  {
    slug: 'calcolo-codice-fiscale',
    title: 'Calcolo Codice Fiscale',
    description:
      'Genera o verifica il codice fiscale partendo dai dati anagrafici, includendo il carattere di controllo finale.',
    metaDescription:
      'Calcolatore codice fiscale: genera il CF e verifica la correttezza formale del carattere di controllo.',
    category: 'strumenti-quotidiani',
    keywords: [
      'codice fiscale',
      'calcolo CF',
  ...
  {
    slug: 'calcolo-scorporo-iva',
    title: 'Calcolo Semplice IVA (Aggiungi/Scorpora)',
    description:
      'Calcola imponibile, IVA e totale fattura o scorpora l’IVA da un totale per le aliquote 22%, 10%, 5% e 4%.',
    metaDescription:
      'Calcolatore IVA per aggiungere o scorporare le principali aliquote italiane da imponibile o totale fattura.',
    category: 'strumenti-quotidiani',
    keywords: [
      'scorporo IVA',
      'calcolo IVA',
  ...
  {
    slug: 'calcolatore-ore-minuti-tempo',
    title: 'Calcolatore Ore e Minuti (Tempo)',
    description:
      'Somma o sottrae ore e minuti in formato sessagesimale convertendo anche da/verso formato decimale.',
    metaDescription:
      'Calcolatrice per sommare e sottrarre ore/minuti con gestione base 60 e conversione in formato decimale.',
    category: 'strumenti-quotidiani',
    keywords: [
      'somma ore',
      'calcolo ore lavoro',
  ...
  {
    slug: 'calcolo-media-aritmetica-ponderata',
    title: 'Calcolo Media (Aritmetica e Ponderata)',
    description:
      'Calcola la media aritmetica semplice e la media ponderata assegnando pesi personalizzati ai valori.',
    metaDescription:
      'Calcolatore media aritmetica e ponderata per serie di valori con pesi personalizzati.',
    category: 'strumenti-quotidiani',
    keywords: [
      'media aritmetica',
      'media ponderata',
  ...
  {
    slug: 'conta-caratteri-parole',
    title: 'Conta Caratteri e Parole',
    description:
      'Conta caratteri, parole, paragrafi e spazi di un testo per relazioni tecniche e documenti a lunghezza vincolata.',
    metaDescription:
      'Conta caratteri e parole online: strumenti per testi tecnici con report su spazi e paragrafi.',
    category: 'strumenti-quotidiani',
    keywords: [
      'conta caratteri',
      'conta parole',
  ...
  {
    slug: 'convertitore-numeri-romani',
    title: 'Convertitore Numeri Romani',
    description:
      'Converte numeri arabi in numeri romani e viceversa con validazione e spiegazione delle regole.',
    metaDescription:
      'Convertitore di numeri romani: da numeri arabi a romani e inverso con verifica delle regole combinatorie.',
    category: 'strumenti-quotidiani',
    keywords: [
      'numeri romani',
      'conversione numeri',
  ...
  {
    slug: 'come-calcolare-percentuale-formule',
    title: 'Come si Calcola la Percentuale (Formule)',
    description:
      'Presenta formule e esempi per calcolare percentuali, valori percentuali e variazioni percentuali tra due numeri.',
    metaDescription:
      'Guida completa al calcolo delle percentuali con formule pratiche e esempi per professionisti.',
    category: 'guide',
    keywords: [
      'percentuale',
      'variazione percentuale',
  ...
  {
    slug: 'guida-regola-del-tre-proporzioni',
    title: 'La Regola del Tre Semplice e Composta: Guida',
    description:
      'Spiega come impostare proporzioni dirette e inverse con esempi pratici per dosaggi, scale e rapporti tecnici.',
    metaDescription:
      'Guida alla regola del tre semplice e composta con casi applicativi per professionisti.',
    category: 'guide',
    keywords: [
      'regola del tre',
      'proporzioni',
  ...
  {
    slug: 'come-calcolare-giorni-lavorativi-scadenze',
    title: 'Come Calcolare i Giorni Lavorativi (Metodo)',
    description:
      'Illustra il metodo per escludere weekend e festività italiane nel calcolo delle scadenze amministrative.',
    metaDescription:
      'Guida al calcolo dei giorni lavorativi con elenco festività italiane e suggerimenti per la pianificazione.',
    category: 'guide',
    keywords: [
      'giorni lavorativi',
      'calendario festività',
  ...
  {
    slug: 'algoritmo-calcolo-codice-fiscale',
    title: "L'Algoritmo del Codice Fiscale: Come Funziona",
    description:
      'Spiega la logica di generazione del codice fiscale italiano con dettaglio su lettere, mesi e carattere di controllo.',
    metaDescription:
      'Guida dettagliata sull’algoritmo del codice fiscale italiano con esempi di calcolo.',
    category: 'guide',
    keywords: [
      'codice fiscale',
      'algoritmo',
  ...
  {
    slug: 'come-scorporare-iva-calcolo-inverso',
    title: "Come Scorporare l'IVA: l'Errore da Evitare",
    description:
      'Mostra la formula corretta per scorporare l’IVA da un totale e gli errori comuni da evitare.',
    metaDescription:
      'Guida allo scorporo dell’IVA con formula corretta e spiegazione degli errori frequenti.',
    category: 'guide',
    keywords: [
      'scorporo IVA',
      'calcolo inverso IVA',
  ...
  {
    slug: 'come-sommare-sottrarre-ore-minuti',
    title: 'Come Sommare Ore e Minuti (Sistema Sessagesimale)',
    description:
      'Spiega come svolgere somme e sottrazioni in base 60 con tecniche per convertire in formato decimale.',
    metaDescription:
      'Guida al calcolo del tempo in formato sessagesimale con conversioni pratiche.',
    category: 'guide',
    keywords: [
      'somma ore',
      'base 60',
  ...
  {
    slug: 'differenza-media-aritmetica-ponderata',
    title: 'Differenza tra Media Aritmetica e Media Ponderata',
    description:
      'Analizza quando usare media semplice o ponderata e fornisce esempi applicativi in ambito professionale.',
    metaDescription:
      'Guida alle medie aritmetiche e ponderate con esempi su costi e prestazioni professionali.',
    category: 'guide',
    keywords: [
      'media aritmetica',
      'media ponderata',
  ...
  {
    slug: 'guida-scrittura-relazioni-tecniche-sintesi',
    title: 'Guida alla Scrittura Efficace (Relazioni Tecniche)',
    description:
      'Suggerimenti per redigere relazioni tecniche concise, chiare e professionali con focus sulla sintesi.',
    metaDescription:
      'Guida alla scrittura efficace di relazioni tecniche: tecniche di sintesi e consigli pratici.',
    category: 'guide',
    keywords: [
      'relazioni tecniche',
      'scrittura efficace',
  ...
  {
    slug: 'come-leggere-numeri-romani-datazione',
    title: 'Come Leggere i Numeri Romani (Spiegazione)',
    description:
      'Spiega le regole di costruzione dei numeri romani con esempi tipici per date e iscrizioni.',
    metaDescription:
      'Guida alla lettura dei numeri romani: regole di composizione e esempi pratici.',
    category: 'guide',
    keywords: [
      'numeri romani',
      'regole composizione',
  ...
  {
    slug: 'gestione-tempo-scadenze-professionisti',
    title: 'Gestione del Tempo per Professionisti Tecnici',
    description:
      'Metodi e strumenti per monitorare il tempo, creare timesheet e gestire scadenze di cantiere e progetto.',
    metaDescription:
      'Guida alla gestione del tempo per professionisti tecnici: timesheet e pianificazione delle scadenze.',
    category: 'guide',
    keywords: [
      'gestione tempo',
      'timesheet',
